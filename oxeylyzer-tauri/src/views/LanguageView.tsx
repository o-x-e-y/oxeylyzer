  ...
  return (
    <div class="flex-1 min-h-0 overflow-y-auto flex flex-col gap-6 max-w-2xl">
      ...
      <section class="border border-neutral-700 p-4 flex flex-col gap-3">
        <div class="text-xs text-neutral-500 uppercase tracking-widest">Current Language</div>
        <div class="flex items-center gap-3">
          <span class="font-mono text-neutral-100 text-base">{appStore.currentLanguage}</span>
        </div>
