...
function CRow(props: {
  ...
  return (
    <div class="flex gap-2 font-mono text-sm py-px">
      ...
      {props.d && (
        <span class={`w-24 text-right shrink-0 text-xs ${props.d.color}`}>{props.d.text}</span>
      )}
    </div>
  );
}
            ...
            <div class="flex flex-col gap-6">
              ...
              <div class="grid grid-cols-2 gap-x-16 items-start">
                ...
                <div>
                  ...
                  <CRow label="Sfb" v1={pct(s1.sfb)} v2={pct(s2.sfb)} d={delta(s1.sfb, s2.sfb)} />
                  <CRow
                    label="Dsfb"
                    v1={pct(s1.dsfb)}
                    v2={pct(s2.dsfb)}
                ...
                <div>
                  ...
                  <CRow
                    label="Total Redir."
                    v1={sum(s1.redirects, s1.redirects_sfs, s1.bad_redirects, s1.bad_redirects_sfs)}
                    v2={sum(s2.redirects, s2.redirects_sfs, s2.bad_redirects, s2.bad_redirects_sfs)}
                    dim
                  />
                  <CSep />
                  <CRow
