    ...
    <div class="flex flex-col gap-4 max-w-3xl">
      ...
      <div class="border border-neutral-700 p-4 flex flex-col gap-4">
        ...
        <div class="flex items-center gap-3">
          <label class="text-sm text-neutral-400 font-mono w-28 shrink-0">
            Based on
          </label>
          <select
        ...
        <div class="flex items-start gap-3">
          ...
          <div class="flex flex-col gap-1 flex-1">
            ...
            <div class="text-xs text-neutral-600">
              Pin characters to fixed positions. Useful for keeping vowel blocks
              in place during improve.
            </div>
          </div>
        </div>
                    ...
                    <Show
                      ...
                      fallback={
                        <span class="text-xs font-mono text-neutral-400">
                          Saved as{" "}
                          <span class="text-neutral-200">{save()?.name}</span>
                        </span>
                      }
                    >
