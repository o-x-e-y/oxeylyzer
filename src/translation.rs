    ...
    pub fn language(&mut self, language: &str) -> Result<&mut Self> {
        ...
        match language.to_lowercase().as_str() {
            ...
            "korean" => Ok(self
                ...
                .to_multiple(vec![
                    ('ㄲ', "ㄱㄱ"), ('ㄳ', "ㄱㅅ"), ('ㅥ', "ㄴㄴ"), ('ㅦ', "ㄴㄷ"), ('ㅧ', "ㄴㅅ"),
                    ('ㄵ', "ㄴㅈ"), ('ㄶ', "ㄴㅎ"), ('ㄸ', "ㄷㄷ"), ('ㄺ', "ㄹㄱ"), ('ㅩ', "ㄹㄱㅅ"),
                    ('ㅪ', "ㄹㄷ"), ('ㄻ', "ㄹㅁ"), ('ㄼ', "ㄹㅂ"), ('ㅫ', "ㄹㅂㅅ"), ('ㄽ', "ㄹㅅ"),
                    ('ㄾ', "ㄹㅌ"), ('ㄿ', "ㄹㅍ"), ('ㅀ', "ㄹㅎ"), ('ㅮ', "ㅁㅂ"), ('ㅯ', "ㅁㅅ"),
                    ('ㅲ', "ㅂㄱ"), ('ㅳ', "ㅂㄷ"), ('ㅃ', "ㅂㅂ"), ('ㅄ', "ㅂㅅ"), ('ㅴ', "ㅂㅅㄱ"),
                    ('ㅵ', "ㅂㅅㄷ"), ('ㅶ', "ㅂㅈ"), ('ㅷ', "ㅂㅌ"), ('ㅹ', "ㅂㅂ"), ('ㅺ', "ㅅㄱ"),
                    ('ㅻ', "ㅅㄴ"), ('ㅼ', "ㅅㄷ"), ('ㅽ', "ㅅㅂ"), ('ㅆ', "ㅅㅅ"), ('ㅾ', "ㅅㅈ"),
                    ('ㆀ', "ㅇㅇ"), ('ㅉ', "ㅈㅈ"), ('ㆄ', "ㅍ"), ('ㆅ', "ㅎㅎ"), ('ㅘ', "ㅗㅏ"),
