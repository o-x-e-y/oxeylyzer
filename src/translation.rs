...
impl TranslatorBuilder {
    ...
    pub fn language(&mut self, language: &str) -> Result<&mut Self> {
        ...
        match language.to_lowercase().as_str() {
            ...
            "hypnogoat" => Ok(self
                .to_multiple(vec![
                    ('ç', " c"), ('Ç', " c"), ('œ', " q"), ('ß', " s"), ('∂', " d"), ('á', " ea"),
                    ('à', "`a"), ('â', " ia"), ('é', " ee"), ('è', "`e"), ('ê', " ie"), ('ì', "`i"),
                    ('í', " ei"), ('î', " ii"), ('ò', "`o"), ('ó', " eo"), ('ô', " io"), ('ù', "`u"), 
                    ('ú', " eu"), ('û', " iu"), ('Á', " ea"), ('Â', " ia"), ('È', "`e"), ('Ê', " ie"), 
                    ('Ì', "`i"), ('Í', " ei"), ('Î', " ii"), ('Ò', "`o"), ('Ó', " eo"), ('Ô', " io"), 
                    ('Ù', "`u"), ('Ú', " eu"), ('Û', " iu"), ('ä', " ua"), ('ë', " ue"), ('ï', " ui"), 
                    ('ö', " uo"), ('ü', " uu"), ('Ä', " ua"), ('Ë', " ue"), ('Ï', " ui"), ('Ö', " uo"), 
                    ('Ü', " uu")
                ])
            ),
            "russian" => Ok(self
